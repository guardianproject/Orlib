...
public class ModSSLSocketFactory implements LayeredSocketFactory {
     ...
     * @return a SSLProtocolSocketFactory
     */
    public static ModSSLSocketFactory getSocketFactory(Proxy.Type proxyType, String proxyHost, int proxyPort) {
    	if (DEFAULT_FACTORY == null) {
    		DEFAULT_FACTORY = new ModSSLSocketFactory();
     ...
     * @hide
     */
    public ModSSLSocketFactory(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
